...
<script>
    var countUpdDate = new Date("Oct 30, 2022 09:30:29").getTime(); // Set the date we're counting down to
...
Only the top 6 placements are shown. E1 means how many times you got the first elim of the game, K1 is for first knock, and D1 is for when you were the first to be dead. TR is the bus driver thanking percentage.
