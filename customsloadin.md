...
<script>
    var countUpdDate = new Date("Oct 30, 2022 11:34:29").getTime(); // Set the date we're counting down to
...
CustmKey: <strong><span style="color:black;background-color:white">letsGOOOOOO</span></strong><br>
