...
<script>
    var countUpdDate = new Date("Oct 25, 2022 16:15:27").getTime(); // Set the date we're counting down to
...
SvrRegion: <strong><span style="color:black;background-color:white">Brazil</span></strong><br>
...
Land at SYNAPSE STATION and stay there until the storm forces you out.
