...
<script>
    var countUpdDate = new Date("Oct 25, 2022 16:11:23").getTime(); // Set the date we're counting down to
...
SvrRegion: <strong><span style="color:black;background-color:white">MiddleEast</span></strong><br>
