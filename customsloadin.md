...
<script>
    var countUpdDate = new Date("Oct 25, 2022 16:27:31").getTime(); // Set the date we're counting down to
...
CustmKey: <strong><span style="color:black;background-color:white">blah</span></strong><br>
