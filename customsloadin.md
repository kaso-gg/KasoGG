...
<script>
    var countUpdDate = new Date("Oct 25, 2022 17:25:32").getTime(); // Set the date we're counting down to
...
CustmKey: <strong><span style="color:black;background-color:white">giveDOWN</span></strong><br>
