...
<script>
    var countUpdDate = new Date("Sep 24, 2022 18:22:38").getTime(); // Set the date we're counting down to
...
Code: <strong><span style="color:black;background-color:white">let's go</span></strong><br>
